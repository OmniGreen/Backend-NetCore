...
namespace Uzx.Infra.Data.EntityConfig.Admin {
    public class CustomersGhostConfiguration : IEntityTypeConfiguration<CustomersGhost> {
        public void Configure (EntityTypeBuilder<CustomersGhost> builder) {
            builder.HasKey (s => s.CustomerGhostId);
            builder.Property (s => s.CategoryId); //Guid
            
            builder.Property (s => s.Name).HasColumnType ("varchar(200)");
            builder.Property(s => s.DeniedDescription).HasColumnType("varchar(200)");
